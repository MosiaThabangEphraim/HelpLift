...
export const TOOLTIP_LABELS: Record<string, string> = {
  ...
  "sign in with a passkey": "Use your fingerprint, face or device PIN instead of a password. Add a passkey first in Settings after signing in",
  "add now": "Add a passkey on this device so you can sign in with your fingerprint, face or PIN",
  "not now": "Skip for now. You can add a passkey any time in Settings",
  "add a passkey": "Save a passkey on this device so you can sign in with your fingerprint, face or PIN",
